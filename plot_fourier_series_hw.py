...
def plot_function_and_fourier(t, func, fourier_func, title, filename):
    _, axs = plt.subplots(1, 3, figsize=(15, 5), sharey=True)  # Share y-axis between plots
...
plot_function_and_fourier(t, f, fourier_series_f, 'f(t) = 1 - |t|', 'fourier_series_function_f.pdf')
plot_function_and_fourier(t, g, fourier_series_g, 'g(t) = t^2', 'fourier_series_function_g.pdf')
plot_function_and_fourier(t, h, fourier_series_h, 'h(t) = |sin t|', 'fourier_series_function_h.pdf')
plot_function_and_fourier(t, k, fourier_series_k, 'k(t) = sin^3 t', 'fourier_series_function_k.pdf')
